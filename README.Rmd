...
```{r Historgram, fig.height = 3, fig.width = 6, fig.align = "center", echo=FALSE}
...
ggplot(publ, aes(x = YEAR)) + 
  geom_histogram(binwidth = 2, color= "white") + 
  scale_x_continuous("", breaks = c(seq(1958, 2020, 4)),
                     expand = c(0, 0)) + 
  scale_y_continuous("", expand = c(0, 0)) + 
  theme_classic()
```

While the bulk of availabe dates have been produced before the advent of AMS dating. Be aware, the archive contains also a small quantity of TL dates.
